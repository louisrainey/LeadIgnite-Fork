...
- Name: VoicemailModal >> should finish recording and close modal
- Location: C:\Users\tyriq\Documents\Github\LeadIgnite-Fork\components\forms\steppers\profile-form\steps\knowledge\voice\_tests\voice-modal.spec.ts:74:6
...
- main:
  ...
  - spinbutton "Personal Phone Number"
  - text: State
  - combobox "State"
  - text: City
  - combobox "City"
  ...
  - switch "Authenticator App"
  - text: SMS Send a code via text message.
  - switch "SMS"
  - text: Email Send a code via email.
  - switch "Email"
