...
const generateMockCallCampaignAnalytics = (): CallCampaignAnalytics => {
	...
	const costBreakdown: CostBreakdown = {
		transport: Number.parseFloat(faker.finance.amount({ min: 1, max: 5 })),
		stt: Number.parseFloat(faker.finance.amount({ min: 1, max: 5 })),
		llm: Number.parseFloat(faker.finance.amount({ min: 1, max: 5 })),
		tts: Number.parseFloat(faker.finance.amount({ min: 1, max: 5 })),
		vapi: Number.parseFloat(faker.finance.amount({ min: 1, max: 5 })),
		total: Number.parseFloat(faker.finance.amount({ min: 10, max: 50 })),
