...
export interface SummaryPlan {
	 ...
	 * ]```
	 *
	 * You can customize by providing unknown messages you want.
	 *
...
export interface TransferPlan {
	 ...
	 *
	 * Usage:
	 * - `blind-transfer`: The assistant forwards the call to the destination without unknown message or summary.
...
export interface TransferDestinationNumber {
	 ...
	 * - Set to unknown E164 number to always use that number as the caller ID. This needs to be a number that is owned or verified by your Transport provider like Twilio.
	 *
...
export interface CustomLLMModel {
	 ...
	 *
	 * - `off` will not send unknown metadata. payload will look like `{ messages }`
	...
	url: string;
	/**
	 * This sets the timeout for the connection to the custom provider without needing to stream unknown tokens back. Default is 20 seconds.
	 * @min 20
	 * @max 600
	 */
	timeoutSeconds?: number;
...
export interface TavusVoice {
	...
	/** This is the context that will be appended to unknown context provided in the persona, if one is provided. */
...
export interface MessagePlan {
	 ...
	 * - If the transcriber doesn't pick up what the user said, this can be used to ask the user to repeat themselves. (From the perspective of the assistant, the conversation is idle since it didn't "hear" unknown user messages.)
	 *
...
export interface StartSpeakingPlan {
	 ...
	 * This plan will still be overridden by unknown matching `customEndpointingRules`.
	 */
	 ...
	 * 1. customEndpointingRules (if unknown match)
	 ...
	 * This plan will also be overridden by unknown matching `customEndpointingRules`.
	 */
...
export interface MonitorPlan {
	 ...
	 *
	 * To use, send unknown control message via a POST request to `call.monitor.controlUrl`. Here are the types of controls supported: https://docs.vapi.ai/api-reference/messages/client-inbound-message
	 *
	 * @default true
	 * @example false
	 */
...
export interface VapiPhoneNumber {
	 ...
	 *
	 * If not set, unknown username/password to the 401 challenge of the SIP INVITE will be accepted.
	 */
...
export interface PhoneNumberPaginatedResponse {
	/** A list of phone numbers, which can be of unknown provider type. */
	results: (
		| ByoPhoneNumber
		| TwilioPhoneNumber
		| VonagePhoneNumber
...
export interface TesterPlan {
	...
	assistantId?: string;
	/**
	 * Add unknown assistant overrides to the test assistant.
	 *
...
export interface TargetPlan {
	...
	phoneNumberId?: string;
	/**
	 * This can be unknown phone number (even not on Vapi).
...
export interface CreateOrgDTO {
	...
	server?: Server;
	/**
	 * This is the concurrency limit for the org. This is the maximum number of calls that can be active at unknown given time. To go beyond 10, please contact us at support@vapi.ai.
	 * @min 1
	 * @max 10
	 */
	 ...
	 * When this is enabled, unknown logs, recordings, or transcriptions will be shipped to the customer endpoints if provided else lost.
...
export interface TokenRestrictions {
	...
	enabled?: boolean;
	/**
	 * This determines the allowed origins for this token. Validates the `Origin` header. Default is unknown origin.
	 *
	 * Only relevant for `public` tokens.
	 */
	allowedOrigins?: string[];
	/**
	 * This determines which assistantIds can be used when creating a call. Default is unknown assistantId.
	 *
	 * Only relevant for `public` tokens.
	 */
...
export interface ServerMessageStatusUpdate {
	 ...
	 *
	 * This will include unknown errors related to the "assistant-request" if one was made.
	 */
...
export interface ServerMessageResponseAssistantRequest {
	/**
	 * This is the destination to transfer the inbound call to. This will immediately transfer without using unknown assistants.
	 *
...
export declare class HttpClient<SecurityDataType = unknown> {
	...
	protected encodeQueryParam(key: string, value: unknown): string;
	protected addQueryParam(query: QueryParamsType, key: string): string;
	protected addArrayQueryParam(query: QueryParamsType, key: string): unknown;
...
> extends HttpClient<SecurityDataType> {
	call: {
		 ...
		 * @secure
		 */
		callControllerCreate: (
			data: CreateCallDTO,
			params?: RequestParams,
		) => Promise<HttpResponse<Call | CallBatchResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Calls
		...
		callControllerFindAll: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<Call[], unknown>>;
		/**
		 * No description
		 *
		 * @tags Calls
	...
	v2: {
		...
		callControllerFindAllPaginated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<CallPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Calls
		...
		assistantControllerFindAllPaginated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<AssistantPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Phone Numbers
		...
		phoneNumberControllerFindAllPaginated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<PhoneNumberPaginatedResponse, unknown>>;
	};
	chat: {
		/**
		 * No description
		...
		chatController: (
			params?: RequestParams,
		) => Promise<HttpResponse<object, unknown>>;
		/**
		 * No description
		 *
		 * @tags Chat
		 ...
		 * @secure
		 */
		chatControllerChatCompletions: (
			data: ChatCompletionsDTO,
			params?: RequestParams,
		) => Promise<HttpResponse<object, unknown>>;
	};
	assistant: {
		...
		assistantControllerCreate: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<Assistant, unknown>>;
		/**
		 * No description
		 *
		 * @tags Assistants
		...
		assistantControllerFindVersions: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<AssistantVersionPaginatedResponse, unknown>>;
	};
	phoneNumber: {
		/**
	...
	file: {
		...
		fileControllerCreateDeprecated: (
			data: CreateFileDTO,
			params?: RequestParams,
		) => Promise<HttpResponse<File, void>>;
		/**
		 * No description
		 *
		 * @tags Files
	...
	knowledgeBase: {
		 ...
		 * @secure
		 */
		knowledgeBaseControllerFindOne: (
			id: string,
			params?: RequestParams,
		) => Promise<
			HttpResponse<
	...
	workflow: {
		...
		workflowControllerFindAll: (
			params?: RequestParams,
		) => Promise<HttpResponse<Workflow[], unknown>>;
		/**
		 * No description
		 *
		 * @tags Workflow
	...
	squad: {
		 ...
		 * @secure
		 */
		squadControllerCreate: (
			data: CreateSquadDTO,
			params?: RequestParams,
		) => Promise<HttpResponse<Squad, unknown>>;
		/**
		 * No description
		 *
		 * @tags Squads
	...
	testSuite: {
		...
		testSuiteControllerFindAllPaginated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<TestSuitesPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Test Suites
		 ...
		 * @secure
		 */
		testSuiteControllerCreate: (
			data: CreateTestSuiteDto,
			params?: RequestParams,
		) => Promise<HttpResponse<TestSuite, unknown>>;
		/**
		 * No description
		 *
		 * @tags Test Suites
		...
		testSuiteTestControllerFindAllPaginated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<TestSuiteTestsPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Test Suite Tests
		 ...
		 * @secure
		 */
		testSuiteTestControllerFindOne: (
			testSuiteId: string,
			id: string,
			params?: RequestParams,
		) => Promise<
		...
		testSuiteRunControllerFindAllPaginated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<TestSuiteRunsPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Test Suite Runs
		...
		testSuiteRunControllerCreate: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<TestSuiteRun, unknown>>;
		/**
		 * No description
		 *
		 * @tags Test Suite Runs
	...
	metrics: {
		...
		analyticsControllerFindAllDeprecated: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<Metrics[], unknown>>;
	};
	analytics: {
		/**
		 * No description
		...
		analyticsControllerQuery: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<AnalyticsQueryResult[], unknown>>;
	};
	log: {
		/**
		 * No description
		...
		loggingControllerCallLogsQuery: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<CallLogsPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Logs
		...
		loggingControllerCallLogsDeleteQuery: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<void, unknown>>;
	};
	logs: {
		/**
		 * No description
		...
		loggingControllerLogsQuery: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<LogsPaginatedResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Logs
	...
	org: {
		...
		orgControllerCreate: (
			data: CreateOrgDTO,
			params?: RequestParams,
		) => Promise<HttpResponse<Org, unknown>>;
		/**
		 * No description
		 *
		 * @tags Orgs
		 ...
		 * @secure
		 */
		orgControllerOrgToken: (
			id: string,
			params?: RequestParams,
		) => Promise<HttpResponse<JwtResponse, unknown>>;
	};
	token: {
		/**
		 * No description
		 ...
		 * @secure
		 */
		tokenControllerCreate: (
			data: CreateTokenDTO,
			params?: RequestParams,
		) => Promise<HttpResponse<Token, unknown>>;
		/**
		 * No description
		 *
		 * @tags Tokens
	...
	credential: {
		...
		credentialControllerGenerateSession: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<CredentialSessionResponse, unknown>>;
		/**
		 * No description
		 *
		 * @tags Credentials
	...
	template: {
		...
		templateControllerCreate: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<Template, unknown>>;
		/**
		 * No description
		 *
		 * @tags Templates
		 ...
		 * @secure
		 */
		templateControllerFindAllPinned: (
			params?: RequestParams,
		) => Promise<HttpResponse<Template[], unknown>>;
		/**
		 * No description
	...
	voiceLibrary: {
		...
		voiceLibraryControllerVoiceGetByProvider: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<VoiceLibrary[], unknown>>;
		/**
		 * No description
		 *
		 * @tags Voice Library
	...
	provider: {
		...
		voiceProviderControllerSearchVoices: (
			...
			params?: RequestParams,
		) => Promise<HttpResponse<VoiceLibraryVoiceResponse[], unknown>>;
		/**
		 * No description
		 *
		 * @tags Providers
