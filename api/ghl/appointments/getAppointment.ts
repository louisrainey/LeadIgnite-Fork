// pages/api/contacts/[contactId]/appointments.ts

import { GetAppointmentsResponse } from '@/types/goHighLevel/appointment';
...
export default async function handler(
  ...
  try {
    ...
    const apiResponse = await fetch(
      `${API_BASE_URL}/contacts/${contactId}/appointments`,
      {
        method: 'GET',
        headers: {
    ...
    const data: GetAppointmentsResponse = await apiResponse.json();
